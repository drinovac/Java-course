...
public class NewtonParallel {
    ...
    public static class NewtonParallelProducer implements IFractalProducer {
        ...
        public void produce(double reMin, double reMax, double imMin, double imMax,
            ...
            Thread[] radnici = new Thread[getWorkers()];
            ...
            for(int i = 0; i < brojTraka; i++) {
                ...
                PosaoIzracuna posao = new PosaoIzracuna(reMin, reMax, imMin, imMax, width, height, yMin, yMax, m, data, cancel, rootedPolynomial);
                while(true) {
                    try {
                        queue.put(posao);
                        break;
