...
public class RecordFormatter {
    ...
    public static List<String> format(List<StudentRecord> list, String[] showingParams) {
        ...
        for(StudentRecord rec: list) {
            ...
            if(showingParams != null) {


                for(String param: showingParams) {
                    if(param.equals("jmbag")){
                        s.append("| ");
